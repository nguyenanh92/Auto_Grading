...
# Dinh nghia dap an
right_anser = {0: 0, 1: 2, 2: 0, 3: 3, 4: 1,5: 1,6: 0,7: 4, 8: 1}

# lấy ra tổng số đáp án của đề thi đó 

count_anser = len(right_anser)
...
ret,thresh2 = cv2.threshold(wrap, 0, 255,cv2.THRESH_BINARY_INV | cv2.THRESH_OTSU)
